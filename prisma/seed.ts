...
const CATALOG: SeedProduct[] = [
  ...
  { name: 'Cone Trufado Cookies & Cream', priceCents: 1500, category: 'cones', imageUrl: 'logo2.png' },
  { name: 'Cone Trufado Prestígio', priceCents: 1500, category: 'cones', imageUrl: 'logo2.png' },
  { name: 'Cone Trufado Maracujá', priceCents: 1500, category: 'cones', imageUrl: 'logo2.png' },
  { name: 'Cone Trufado Morango', priceCents: 1500, category: 'cones', imageUrl: 'logo2.png' },
  // Bolos artesanais
  ...
  { name: 'Bolo de Baunilha', priceCents: 11000, category: 'bolos', imageUrl: 'bolo3.png' },
  // Ovos de páscoa trufados
  { name: 'Ovo Trufado Brigadeiro Gourmet', priceCents: 4500, category: 'ovos', imageUrl: 'logo2.png' },
  { name: 'Ovo Trufado Prestígio', priceCents: 4500, category: 'ovos', imageUrl: 'logo2.png' },
  { name: 'Ovo Trufado Ninho com Morango', priceCents: 5000, category: 'ovos', imageUrl: 'logo2.png' },
  { name: 'Ovo Trufado Kinder Bueno', priceCents: 5500, category: 'ovos', imageUrl: 'logo2.png' },
]
